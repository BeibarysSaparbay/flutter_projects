import 'package:body_mas/widgets/left_bad.dart';
import 'package:body_mas/widgets/right_bar.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: (){
                double _h = double.parse(_heightCon.text);
                double _w = double.parse(_weightCon.text);
                setState(() {
                  _bmiResult = _w / (_h * _h);
                  if(_bmiResult > 25){
